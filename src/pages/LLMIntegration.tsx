    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">LLM API Integration</h1>
            <p className="text-slate-600 mt-2">Manage connections to AI language model providers</p>
          </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge 
                        ...
                        className={provider.status === "connected" ? "bg-green-50 text-green-700" : ""}
                      >
                        {provider.status}
                      </Badge>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Stream responses in real-time</p>
                      </div>
                      <Switch checked={true} />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Retry failed requests automatically</p>
                      </div>
                      <Switch checked={true} />
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="text-sm text-slate-500">Across all models</div>
                </CardContent>
              </Card>
            </div>
                    ...
                    <div key={provider.name} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-slate-500">{provider.usage}% of limit</div>
                        </div>
                      </div>
