    ...
    <div className="relative">
      {tier.isPopular && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
          <div className="bg-gradient-to-r from-vibe-primary to-vibe-secondary text-white px-4 py-2 rounded-full shadow-lg animate-pulse-glow">
            <div className="flex items-center space-x-1">
              <Star className="w-4 h-4 animate-bounce-gentle" />
      ...
      <EnhancedCard 
        className={`p-6 h-full relative ${tier.bgGradient} ${tier.borderColor} ${
          tier.isPopular ? 'ring-2 ring-vibe-primary ring-offset-2 mt-4' : ''
        }`}
        hoverEffect="lift"
      >
