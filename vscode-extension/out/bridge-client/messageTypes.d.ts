 ...
 */
export type MessageType = 'auth' | 'ping' | 'pong' | 'planning_agent_request' | 'planning_agent_response' | 'task_created' | 'task_updated' | 'project_analyzed' | 'file_analyzed' | 'error' | 'status_update';
...
export type PlatformMessage = AuthMessage | PingMessage | PongMessage | PlanningAgentRequestMessage | PlanningAgentResponseMessage | TaskCreatedMessage | TaskUpdatedMessage | ProjectAnalyzedMessage | FileAnalyzedMessage | ErrorMessage | StatusUpdateMessage;
